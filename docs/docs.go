...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/account/verify": {
            "post": {
                "description": "Verify user account using email and API Key sent via email",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Verify account using email and API key",
                "parameters": [
                    {
                        "description": "Verification payload (email, apiKey)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/send/excel": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Message template with placeholders (e.g. Hello {{Name}})",
                        "name": "text",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "Optional Media File Upload (Image / Video / Document / Audio)",
                        "name": "media",
                        "in": "formData"
                    },
                    {
